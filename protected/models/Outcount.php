...
/**
 * This is the model class for table "outcount".
 *
 * The followings are the available columns in table 'outcount':
 * @property integer $outcount_id
 ...
 */
class Outcount extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('outcount_id',$this->outcount_id);
	 ...
	 * @return Outcount the static model class
	 */
